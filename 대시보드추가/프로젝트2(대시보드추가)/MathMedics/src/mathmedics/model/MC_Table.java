...
public class MC_Table {

    int ch1, ch2, ch3, ch4, ch5, ch6, ch7, ch8, ch9;
    String grade, MClass, name;
    ...
    public MC_Table(int ch1, int ch2, int ch3, int ch4, int ch5, int ch6, int ch7, int ch8, int ch9, String grade, String MClass, String name) {
        this.ch1 = ch1;
        this.ch2 = ch2;
        this.ch3 = ch3;
        this.ch4 = ch4;
