...
public class Sidebar_SL_Controller extends Sidebar_Controller implements Initializable {
    ...
    void into_SecondGrade(MouseEvent event) throws IOException {
        ...
        try {
            Parent second = FXMLLoader.load(getClass().getResource("/mathmedics/view/board_second_grade.fxml"));
    ...
    void into_ThirdGrade(MouseEvent event) throws IOException {
        Stage newStage = new Stage();
        Stage stage = (Stage) third.getScene().getWindow();
        try {
            Parent second = FXMLLoader.load(getClass().getResource("/mathmedics/view/board_third_grade.fxml"));
    ...
    void into_allGrades(MouseEvent event) throws IOException {
        ...
        try {
            Parent second = FXMLLoader.load(getClass().getResource("/mathmedics/view/board_all_grade.fxml"));
